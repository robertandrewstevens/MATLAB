...
**Exercise 7.1** Write a function named find target that encapsulates the code, from Section 4.14, that finds the location of a target value in a vector.
...
In general, if you write a function using only element-wise operators and functions that work on vectors, then the new function will also work on vectors.
...
You can use a loop, or if you want to be clever, you can take advantage of the fact that exp(ln(a) + ln(b)) = a*b.
