...
**system of equations:** A set of equations written in terms of a set of variables such that the equations are inter-tangled.
...
3. Assuming that Step 2 works, you can use ode45 to estimate the solution for the time interval t[0] = 0, t[e] = 30 with the initial condition x = 1, y = 2 and z = 3.
