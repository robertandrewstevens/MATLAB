...
```{r}
# library("schoolmath") # for function 'gcd'
# prints "n is a prime!" several times per iteration and is VERY slow!
...
GCD <- function(a, b) { 
  if(b == 0) { 
    ...
    value <- GCD(b, a %% b) # '%%' in R is same as 'mod(a, b)' in MATLAB
    return(value)
  }
}
